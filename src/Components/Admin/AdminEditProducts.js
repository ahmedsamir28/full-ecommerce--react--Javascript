...
import AdminEditProductsHook from '../../Custom/Products/edit-ProductsHook';
...
const AdminEditProducts = () => {
    ...
    return (
        <div className='container'>
            <div className="">
                <div className="text-2xl font-bold text-zinc-500  capitalize mb-5">Product modification</div>
                <div>
